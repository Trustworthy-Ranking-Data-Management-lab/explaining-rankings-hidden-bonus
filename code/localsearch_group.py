...
if __name__ == '__main__':
    ...
    solved = 0
    with Pool(processes=8, initializer = localsearch_functions.init_globals_group, initargs = (points, ranking, mapping, K, NUM_GROUPS)) as pool:
        dosolvepartial = partial(localsearch_functions.dosolve_groups, startTime = startTime, timelimit = TLIMIT)
    ...
    print(f"Final line, {NUM_DATA}, {DIM}, {NUM_GROUPS}, {K}, - No dominance - , Localsearch, {round(timetaken,2)}, {sol}")
