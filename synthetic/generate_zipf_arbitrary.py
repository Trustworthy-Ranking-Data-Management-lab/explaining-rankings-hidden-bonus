...
truthfile = r"zipf_sol_singleton_" + str(NUM_DATA) + "_" + str(DIM) + "_" + str(KRATIO) + ".txt"
...
outfile_name = r"zipf_" + str(NUM_DATA) + "_" + str(DIM) + "_" + str(KRATIO) + ".txt"
...
with open(outfile_name, "w") as f:
    ...
    rankings = sorted(rankings, key = lambda tup : (tup[0], tup[1]), reverse=True)
