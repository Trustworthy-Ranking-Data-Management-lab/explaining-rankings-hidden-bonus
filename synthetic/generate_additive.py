...
truthfile = r"sol_" + str(NUM_GROUPS) + "group_" + str(NUM_DATA) + "_" + str(DIM) + "_" + str(KRATIO) + ".txt"

with open(truthfile, "w") as f:
    weights = rng.uniform(0, DATA_UPPER_BOUND, DIM).tolist()
...
for i in range(NUM_DATA):
    data = rng.uniform(0, DATA_UPPER_BOUND, DIM).tolist()
...
outfile_name = r"" + str(NUM_GROUPS) + "group_" + str(NUM_DATA) + "_" + str(DIM) + "_" + str(KRATIO) + ".txt"
